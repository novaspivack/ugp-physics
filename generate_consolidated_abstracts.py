...
PAPERS = [
    ...
    ("P12",     "papers/12_unified_rigidity/Unified_Rigidity_Capstone.tex",
                "Unified Rigidity Theorem for PSC/UGP Universes"),
    ("P13",     "papers/13_MFRR_foundational_monograph/MFRR_explanatory_summaries/SUMMARY_FOR_PHYSICISTS_AND_REFEREES/MFRR_summary_for_physicists.tex",
                "MFRR Foundational Monograph (Physics Summary)"),
...
def build():
    ...
    lines = [
        ...
        f"# Generated: {now}",
        f"# Repository: {REPO}",
        f"# Papers included: {len(PAPERS)} (P00 = survey guide; P01-P26 = main corpus)",
        "#",
