...
def _register_defaults() -> None:
    ...
    def _load_three_tape_cmca() -> type[SimEngine]:
        # Wraps canonical P45 implementation at
        # papers/45_three_tape_cmca/scripts/three_tape_cmca.py.
        # Fails with a clear ImportError if that path is not present.
        from ugp_viz.three_tape_cmca import ThreeTapeCMCAEngine
        return ThreeTapeCMCAEngine
    ...
    register("three_tape_cmca", _load_three_tape_cmca)  # wraps canonical P45
