...
| 55 | The Octonionic Shadow of GF(7): Color, Chirality, and Three Generations from a Quadratic-Residue Difference Set | `papers/55_octonionic_shadow/` |

To compile all papers: `bash compile_all_papers.sh --skip-mfrr` (56 papers, ~120 s).
...
`tutorials/interactive_explainer/` is a self-contained browser-based tutorial series covering the full UGP/GTE theory across 8 learning paths and 30 lessons.

**Live:** https://novaspivack.github.io/ugp-physics/tutorials/interactive_explainer/

All 8 paths are complete. Lessons include KaTeX-rendered equations, SVG diagrams, and guided exercises. No installation required — runs in any modern browser. Each key result links directly to its Lean 4 machine proof on GitHub and its source paper on Zenodo.

| Path | Topic | Lessons |
|------|-------|---------|
| 1 | Foundations: The Triangle | L01–L07 (7 lessons) |
| 2 | Selection: Why This Polynomial? | L08–L11 (4 lessons) |
| 3 | Particles: Kinks, Fields, Masses | L12–L17 (6 lessons) |
| 4 | Forces: Gauge Structure from Winding | L18–L21 (4 lessons) |
| 5 | Spacetime and Gravity | L22 (1 lesson) |
| 6 | Quantum Mechanics | L23–L24 (2 lessons) |
| 7 | Cosmology | L25–L28 (4 lessons) |
| 8 | Context and Predictions | L29–L30 (2 lessons) |
