...
## 083D addition: Two-loop sin²θ_W closure

New script graduated from research-sandbox:

| Script | Produces |
|---|---|
| `papers/31_weinberg_angle/scripts/sin2_theta_W_two_loop.py` | SM Higgs threshold correction to sin²θ_W with GTE-derived inputs |

Expected output: sin²θ_W = 0.23129154, +0.038σ from PDG 2024 (0.23129 ± 0.00004)

GTE inputs used:
- λ = 384729/1664000 (Wolfenberg correction, CatAL)
- m_H = 125.2499 GeV (CatAL, SRRG correction)
- M_W/√(10/13) = 91.629 GeV for M_Z (CatAD)
- cos²θ_W = 10/13 exact (CatAL)
- α_em(M_Z) = 1/128 from 1/α_em(0) = 2^|Z₇| + N_gen² = 137 (CatB)

Run with `python3 papers/31_weinberg_angle/scripts/sin2_theta_W_two_loop.py`.
