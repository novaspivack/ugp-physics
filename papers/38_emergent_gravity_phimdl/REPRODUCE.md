...
## 083C additions (2026-06-02): MS-bar dim-reg and C_logfin precision

New scripts graduated from research-sandbox:

| Script | Produces |
|---|---|
| `papers/38_emergent_gravity_phimdl/scripts/phimdl_casimir_dimreg.py` | MS-bar dim-reg Casimir integral: C_zero = +1/3, C_logfin = −0.70703261; ΔM = +31.22 MeV; M^Q = 321.32 ± 15.6 MeV (CatA) |
| `papers/38_emergent_gravity_phimdl/scripts/casimir_clogfin_precision.py` | Higher-precision C_logfin to 12 significant figures; tests analytic candidates (open: exact closed form) |

Run with `python3 <script path>` from the repo root.

*REPRODUCE.md — P38 — 2026-05-26; EPIC_080 casimir correction 2026-05-29*
