...
| `DWeightSRFormula.lean` | ✅ commits `74f2294`, `28dce40f` (ugp-lean) | [D]-weighted SR formula: `dmdl_qec_sr_bundle`, `dmdl_dweight_sr_formula`, `dmdl_proper_time_ratio`, `dmdl_dweight_positive` — zero sorry, standard axioms only |
