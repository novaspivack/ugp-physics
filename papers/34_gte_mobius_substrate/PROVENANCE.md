...
- **2026-06-10:** Degree-precise TPC language (P51 classification theorem propagation): new Remark "Degree-exact classification of the decision-theoretic shadow" in §Position in the Computability Hierarchy (deg exactly 0′, Δ₂⁰-Turing-complete, Gold–Putnam stratum; cites `Gold1965`, `Putnam1965`, `SpivackPolynomialTransputation`); §TPC vs. Oracle Computation first bullet restated operationally (degree-theoretic equality at 0′ vs. no certified finite-time Σ₁⁰ decisions); "incommensurable with the arithmetical hierarchy" replaced by the type-distinction + degree-exact-shadow statement; §Zone L2 gains the f_MDL three-part PSC-correction cross-reference to P51.
- **2026-06-11:** Fine-end reading conditioning — the two-scale passage in §The Algebraic Lifting Theorem and Physical Predictions and the Planck-cell counts in §Particle Compositeness and Planck-Scale Bounds now carry an explicit scoping clause: the cell-spacing-equals-$\ell_{\rm Pl}$ identification is the conventional fine-end working hypothesis, a calibration reading of the discrete certificate rather than a GTE derivation. Numbers unchanged; the 15-cell information-theoretic minimum and the Compton-limited conclusion are noted as reading-independent.
