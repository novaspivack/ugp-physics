...
## 083C additions (2026-06-02): D_top and Ω_DM h² correction

New scripts graduated from research-sandbox:

| Script | Produces |
|---|---|
| `papers/29_dark_sector_braid_atlas/scripts/h0_z7_topological_dilution.py` | D_top = exp(−1/N_c) = exp(−1/3); Ω_DM h² = 0.11994 (−0.044% Planck 2018) |
| `papers/29_dark_sector_braid_atlas/scripts/h0_dark_matter_relic_density_v2.py` | ADM relic density with D_top correction; Ω_m h² = 0.142 |
| `papers/29_dark_sector_braid_atlas/scripts/dm_direct_detection_gte.py` | σ_SI = 9.76×10⁻⁶¹ cm² (Higgs portal); E_R^max ≈ 1.7×10⁻⁴ eV; UFIDM classification (CatAD) |
