...
Paper~P48~\cite{SpivackGTECompleteFramework} is the synthesis capstone: a 280+ page
monograph presenting the complete PSC-to-cosmology derivation chain in eleven chapters,
...
and a complete falsification table.
...
$H_0$ (P47) & $67.95$~km/s/Mpc ($T_{\rm CMB}$ sole input; epoch-dependent) & $67.66\pm0.42$~km/s/Mpc & $+0.7\sigma$ & CatB \\
Quantum kink mass $M^Q$ (P38, P42) & $321.32 \pm 15.6$~MeV (MS-bar dim-reg) & --- & see P42 & CatA \\
...
The ugp-lean library currently comprises 304 Lean~4 modules.  Recent work contributed 19 additional zero-sorry theorems across new modules including
...
The 49 papers of the UGP Physics programme (P01--P49), the ugp-lean Lean~4 library, and the
