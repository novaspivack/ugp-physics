...
# Quantum (pole) kink mass: one-loop domain-wall pole mass from the P42
# GJQW interface dim-reg determination, M^Q = 281 +/- 21 MeV (scheme-explicit
# band). The value enters only the two-soliton threshold r_2S below, whose
# contribution is set to zero (not a valid 3+1D diagram); the published
# a_mu^GTE verdict is independent of M^Q.
M_kink_quantum = 281.0  # MeV from P42 CatA (one-loop pole mass)
