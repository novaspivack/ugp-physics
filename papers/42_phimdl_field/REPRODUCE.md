...
## 083C additions (2026-06-02): One-loop corrections and quantum kink mass

New scripts graduated from research-sandbox:

| Script | Produces |
|---|---|
| `papers/42_phimdl_field/scripts/phimdl_cw_effective_potential.py` | V_eff^(1) = −2.367×10⁻² GeV⁴ at all 7 Z₇ vacua (Z₇ degeneracy preserved) |
| `papers/42_phimdl_field/scripts/phimdl_kink_fluctuation_spectrum.py` | PT spectrum s=1; zero mode + continuum at m_φ |
| `papers/42_phimdl_field/scripts/phimdl_casimir_3d1d_correction.py` | MS-bar dim-reg: ΔM = +31.22 MeV; M^Q = 321.32 ± 15.6 MeV (CatA) |
| `papers/42_phimdl_field/scripts/phimdl_casimir_tba.py` | TBA kernel φ(θ)=2/cosh(θ); ZZ S-matrix (CatAD) |
| `papers/42_phimdl_field/scripts/phimdl_casimir_dimreg.py` | MS-bar dim-reg Casimir integral: C_zero = +1/3, C_logfin = −0.70703261 (CatA) |
| `papers/42_phimdl_field/scripts/casimir_clogfin_precision.py` | Higher-precision C_logfin computation; tests whether C_logfin = −1/√2 (open) |
