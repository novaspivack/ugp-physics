...
SUPERSEDED: this computation is incorrect — it omits the renormalized
diagrammatic add-back, inverts the Levinson phase-shift convention
(double-booking ~m/12pi of spectral weight), and its mu-flow (+m^3/8pi^2)
corresponds to no consistent scheme. The corrected one-loop result is
...
out_path = "papers/42_phimdl_field/scripts/phimdl_casimir_dimreg_results.json"
