...
SUPERSEDED: the coefficient C_logfin belongs to the superseded quantum-kink-mass
bookkeeping (inverted Levinson convention, missing diagrammatic add-back) and
carries no physical content. The corrected one-loop result is
DeltaM = -7..-10 MeV, M^Q = 281 +/- 21 MeV (kink_pole_mass_interface_dimreg.py).
