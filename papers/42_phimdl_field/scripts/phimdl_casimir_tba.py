...
Comparison baselines:
  ...
  - The log-cutoff value DeltaM = -59.67 MeV (C_scatt = -4.746) is a
    superseded cutoff artifact; the corrected one-loop interface dim-reg
    result is DeltaM = -7..-10 MeV, M^Q = 281 +/- 21 MeV
...
It is NOT the O(1) one-loop wall correction Delta_M = -7..-10 MeV computed in 3+1D
(interface dim-reg, kink_pole_mass_interface_dimreg.py).
""")
...
print(f"One-loop wall correction (3+1D interface dim-reg, CatA): Delta_M = -7..-10 MeV")
print(f"Ratio: Luescher / wall ~ {abs(Delta_M_Luescher)/10.0:.4f}  [Luescher << wall]")
...
print(f"  [Compare: superseded log-cutoff C_scatt = -4.746, Delta_M = -59.67 MeV;")
print(f"   corrected interface dim-reg Delta_M = -7..-10 MeV, M^Q = 281 +/- 21 MeV]")
print(f"\nThe CMCA cutoff result differs strongly from the large-cutoff result,")
