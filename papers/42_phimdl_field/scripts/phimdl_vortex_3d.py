#!/usr/bin/env python3
"""
Phi_MDL domain wall junction (vortex line) tension in 3+1D.
...
Physical parameters (from the domain-wall tension computation, phimdl_3d_domain_wall.py):
...
# --- Physical constants and parameters (from phimdl_3d_domain_wall.py) ---
N7 = 7
...
SIGMA_PRIOR_MEV_PER_FM2 = 7450.31           # sigma from phimdl_3d_domain_wall.py [MeV/fm^2]
...
# ---------------------------------------------------------------------------
# Unit conversion (consistent with phimdl_3d_domain_wall.py)
#
...
print(f"  Domain wall tension:   sigma  = {SIGMA_PRIOR_MEV_PER_FM2:.2f} MeV/fm^2  (from phimdl_3d_domain_wall.py)")
...
print("FINAL RESULTS")
print("=" * 72)
print(f"  sigma  = {SIGMA_PRIOR_MEV_PER_FM2:.2f} MeV/fm^2  (domain wall tension, phimdl_3d_domain_wall.py)")
