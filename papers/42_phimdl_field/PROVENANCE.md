...
public repository. The `WindingCoinDecoupling.lean` module was developed in
`ugp-lean-exp` during EPIC_074 and will be graduated to `ugp-lean` at the next
graduation pass. Two auxiliary lemmas (`bps_kink_integral_eq_four`,
