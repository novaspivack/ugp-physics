...
python3 pmdl_carrier_gaussian_split.py
```
...
| `entanglement_analysis.py` | Tape-tape entanglement negativity scan (N = 0.24 at G_eff = 0.5) |
...
| `pmdl_carrier_gaussian_split.py` | Exact Gaussian factorization of ln Z[J] (carrier/record split): A1 quadrature vs closed form 9.4×10⁻¹⁴; A2 measure-factor spread exactly 0.0 over 40 records/sources; A3 coding identity −ln P = S + ln Z to 1.8×10⁻¹²; A4 Hessian w-independence exact; N1 K_extra>0 null fires (spread 0.957 at ε=0.01) — certifies K_self = K_carrier + K_records (§PMDL-Λ duality) |

Artifacts: `scripts/baryon_number_l2_correspondence_results.json`,
`scripts/pmdl_carrier_gaussian_split_results.json`
...
|---|---|---|---|
| Ω_Λ (census evaluation) | 0.6899 | +0.18σ from Planck 2018 (0.6889±0.0056) | PSCEpochSelection.lean |
| Ω_Λ carrier floor | 3π/14 = 0.67320 | lower bracket | pmdl_carrier_gaussian_split.py (split certificates) |
...
| Bell violation | S=2.4459 | 86.5% Tsirelson | bell_inequality_test.py |
| Quantum entanglement | Negativity=0.24 at G_eff=0.5 | — | entanglement_analysis.py |
| SRRG-CA bridge | 1/φ = 0.6180 | exact algebraic | SRRGCABridge.lean |
| m_W (1-loop) | 80.37 GeV | 0.003% from PDG 2024 (80.3692) | W propagator (g×v_PSC/2, g=0.653) |
