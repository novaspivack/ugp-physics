...
\caption{Five a priori distinct descriptions of the GTE holographic encoding
  structure are pairwise equivalent (Theorem~\ref{thm:ghet}). Among $T_1,T_2,T_4,T_5$,
  any single description determines the other three unconditionally; relating any of
  them to $T_3$ additionally assumes the standard Bekenstein-Hawking coefficient
  $1/4G$ as an external premise (Remark~\ref{rem:area_unit}).}
