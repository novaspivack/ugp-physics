...
- `rule110-lean` — Rule 110 Turing universality via Cook's theorem (conditional operational readback core: `cook_operational_stage3_tm_microstep_readback`) and the finite NAND functional-completeness identity (`rule110_center1_is_nand`)
