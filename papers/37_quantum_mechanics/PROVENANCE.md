...
- **2026-06-10:** §Measurement and Zone L2: stale "future work" sentence replaced — the precise equivalence (Zone L2 boundary = event-adjudication transition of the Three-Level MDL Unification Theorem) is now established in P51 (`SpivackPolynomialTransputation`, CatAD; bundle certificate `mdl_three_level_unification`); f_MDL three-part PSC-projection characterization sentence added (CatAL, `psc_projection_gives_fmdl`).
