...
- GTE-to-braid mapping: `papers/17_braid_atlas/scripts/braid_to_gte_mapper.py` — graduated 2026-05-31.
- SM fermion mapping test suite: `papers/17_braid_atlas/scripts/test_all_particles.py` — graduated 2026-05-31; verifies all 12 fundamental fermions map correctly.
