...
- Particle tuples for the ML scripts are embedded in `topology_lab/pillar2c_foundational_fortification/Dynamic_Feature_Analysis.py` (see file for line range).
