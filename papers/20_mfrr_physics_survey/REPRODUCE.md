...
```bash
# SM universe scan (34,560 universes)
cd papers/01_SM/canonical_run
python3 comp_p01_SM_universe_scan.py

# SRRG basin analysis (TS1: 8,704 random starts)
python3 comp_p01_srrg_basin.py

# Information Profit Threshold (E32)
python3 comp_p01_profit_threshold.py
```
