...
- **2026-06-02 (083C quality audit — commit bba2d17e):** Added exact kink-antikink S-matrix (ZZ model, sinh-Gordon B=1): S(θ)=(sinhθ−i)/(sinhθ+i) (CatAD); TBA kernel φ(θ)=2/cosh(θ) (CatAD); large-u asymptotics u·J−π/2∼−1/u (CatAD).
- **2026-06-10 (quantum kink mass correction + P51 cross-references):** §smatrix quantum-kink-mass sentence corrected — prior ΔM=+31.22 MeV, M^Q=321.32±15.6 MeV (renormalization-bookkeeping artifact; C_logfin parenthetical withdrawn) replaced by ΔM=−7…−10 MeV (on-shell/MS-bar at μ=m_φ), M^Q=281±21 MeV (CatA; consistent with M_kink=290.10 MeV within the scheme band; method and scripts in P42). §Transputation: added P51 citation (Three-Level MDL Unification Theorem, CatAD) and DSAC-as-[D]-member sentence (NEMS Paper 77). ZZ S-matrix and TBA kernel statements unchanged.
- **2026-06-11 (calibrated-reading remark):** New Remark "Lattice spacings are calibrated readings" after the No-CA-Replica theorem: Theorem no-CA-replica + the Algebraic Descent Theorem jointly imply the discrete certificate carries no intrinsic lattice spacing — a spacing is a sector-indexed reading (calibration against Φ_MDL observables). Matter-sector (F₂₁-EFT) reading MDL-saturated at a = ℏc/Λ_GTE ≈ 0.097 fm (Tape Saturation Theorem, CatAD conditional on the Compton-Support Criterion, proven minimal by the Boundary Equivalence Theorem; cites P50); fine-end reading a ≈ l_Pl (used in §Non-perturbative Quantum Gravity) identified as a working hypothesis; separation = the hierarchy monomial M_Pl/Λ_GTE = 3¹⁰·7¹⁸/2⁴.
