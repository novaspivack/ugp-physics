...
**Lean file:** `~/ugp-lean-exp/UgpLean/VEVProof/PSCEntropyDuality.lean`
...
**File:** `~/ugp-lean-exp/UgpLean/VEVProof/PSCEntropyDuality.lean`
...
| `~/ugp-lean-exp/UgpLean/VEVProof/PSCEntropyDuality.lean` | Complete Lean proof |
