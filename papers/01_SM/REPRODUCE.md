...
- Primary σ (empirical): ≈ 0.003 %
- Primary σ (theoretical, dual-path): 0.295 %
- W-ρ: 1.04900 (PASS)
...
**Expected (2026-06-11 audit):** empirical primary σ ≈ **0.003%**; dual-path “theoretical” σ ≈ **0.295%** (URC + empirical UCL, theoretical `renorm_K`); `k_gen` in `theoretical_coefficients.json` ≈ **1.53884**.  The dual-path theoretical arm of `dual_path_comparison.json` is the source of `tab:theoretical_primary` in the paper (per-particle masses and the 0.295% RMS); SHA-256 hashes for the frozen bundle are in `canonical_run/CANONICAL_HASHES.md`.
...
| `CANONICAL_HASHES.md` | SHA-256 hashes for 2026-06-11 canonical bundle |
