...
EPIC 12 — Round 1 Preparation: Structural decomposition of 29/9

GOAL: Before the Genius Team reasons about WHY 29/9, enumerate all the
natural structural decompositions of 29/9 in terms of:
  - N_c = 3 (QCD colour rank)
  - strand_count = (N_c²-1)/4 = 2 (EPIC 9)
  - δ = N_c + (N_c²-1)/2 = 7 (EPIC 9 mirror offset)
  - b₁ = 73 (lepton ladder; EPIC 9)
  - θ_Koide = (N_c²-1)/(4N_c²) = 2/9 (EPIC 9)
  - Various GUT/SO(10) quantities from EPIC 10

This gives the Genius Team a concrete "landscape" of possible decompositions
to reason about physically.

We ALSO enumerate candidate absolute-scale formulas that give sum_mν in
[55, 120] meV, and score each for structural cleanness.
"""
...
# Core constants (from EPICs 9-11)
N_c = 3
...
print("=" * 72)
print("EPIC 12 Round 1 Prep: Structural Decomposition Landscape of 29/9")
print("=" * 72)
...
decompositions.append(("D5: rank(SU5) - δ/N_c²", f, "GUT rank - EPIC 9 offset ratio"))
...
# D9: (N_c + 2)(N_c² - 1)/(4·(N_c²-2)) + const? Test γ_d connection (EPIC 10)
...
# D10: 29/9 as sum/diff of EPIC 10 VV coefficients α_d=13/9, β_d=-7/6, γ_d=-5/14
...
M_GUT_best = 2.17e25  # best-fit from EPIC 11
...
Target: m_ν_g ∝ b_g^{{29/9}} to match EPIC 11 ratio
...
print(f"  and δ = 7 is the mirror offset from EPIC 9")
