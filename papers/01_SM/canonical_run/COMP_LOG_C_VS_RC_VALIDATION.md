...
All handoff `code/*.py` scripts that saved figures to `/home/claude/branch_a/` were **broken on import**. They now write under **`handoff/figures/`** relative to the unpacked handoff package.
