...
**Session:** PSC entropy-contraction duality synthesis (Lean certification)  
**Date:** 2026-05-15  
**Status:** COMPLETE — both open axioms discharged, zero sorry  
**Lean file:** [`SrrgLean/VEVProof/PSCEntropyDuality.lean`](https://github.com/novaspivack/srrg-lean/blob/main/SrrgLean/VEVProof/PSCEntropyDuality.lean)
...
### Jacobian contraction (entropy scaling)
...
**Structural note:** No Jacobian theorem from measure theory is needed. The entropy
functional `S(ε) = -log₂(ε)` already encodes the Jacobian via the `-log₂(measure)` definition.
The dimensional core of information geometry collapses here to `Real.log_mul + ring`.

### Bayesian information-gain viewpoint
...
### Rate-distortion interpretation (uniform surrogate)
...
### Lean formalization spine

**File:** [`SrrgLean/VEVProof/PSCEntropyDuality.lean`](https://github.com/novaspivack/srrg-lean/blob/main/SrrgLean/VEVProof/PSCEntropyDuality.lean)
...
| File | Description |
|------|-------------|
| `proof_psc_duality_jane.py` | Jacobian / log-scaling checks and Mathlib roadmap |
| `proof_psc_duality_adam.py` | Bayesian information-gain cross-check |
| `proof_psc_duality_synthesis.md` | This synthesis document |
| [`SrrgLean/VEVProof/PSCEntropyDuality.lean`](https://github.com/novaspivack/srrg-lean/blob/main/SrrgLean/VEVProof/PSCEntropyDuality.lean) | Complete Lean proof |
