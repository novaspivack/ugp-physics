...
The frozen artifact bundle in `papers/01_SM/canonical_run/` was produced by verified UGP_GTE_SM_Verifier runs. The UCL coefficient comparison bundle was **refreshed 2026-05-30** via `comp_p01_ucl_coeff_audit.py` after aligning `calculate_theoretical_coefficients()` with `k_gen = φ cos(π/10)` (Lean `thm_ucl2_fully_unconditional`; paper/JSON fixed in commit `3762f9e4`, Python in 2026-05-30).

### Key Verified Outputs

| Quantity | Canonical Value | Source |
|----------|----------------|--------|
| Primary σ GoF (empirical) | **≈ 2.95 × 10⁻³ %** (2026-05-30 audit) | `dual_path_comparison.json` |
| Primary σ GoF (theoretical, dual-path) | **≈ 0.295 %** (2026-05-30 audit) | `dual_path_comparison.json` |
| Fully theoretical UCL only (no empirical coeffs) | **≈ 1.11 %** primary σ (2026-05-30) | `fully_theoretical_results.json` |
...
| `CANONICAL_HASHES.md` | SHA-256 table for 2026-05-30 verifier bundle |
