...
| `rule110_center1_nand_functional_completeness` | finite two-input Boolean functional completeness (not Turing universality); follows from axiom; formerly named `rule110_turing_universal_algebraic` (now a deprecated alias) |
...
| Theorem | Result |
|---------|--------|
| `phimdl_turing_universal` | Φ_MDL Turing universality via Cook's theorem composed with the proved stepwise Φ_MDL–Rule 110 simulation (CatAL conditional, zero sorry, one named axiom: `cook_rule110_simulates_computable`) |
