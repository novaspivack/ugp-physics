...
**Paper:** P40 — "Algebraic Characterization of Rule 110 over GF(7) and Finite NAND Functional Completeness"  
**Date:** 2026-05-25  
**Author:** Nova Spivack  
...
### Result 3: Finite NAND functional completeness (CatAL, Cook-independent)

**Lean:** `rule110_center1_nand_functional_completeness` (finite two-input Boolean
functional completeness, not Turing universality) from `boolean_nand_complete`
(Sheffer 1913). Formerly named `rule110_turing_universal_algebraic`; that name is
kept in `rule110-lean` only as a deprecated alias.

**Cross-route:** `ugp-lean/UgpLean/Universality/PhiMDLUniversality.lean` —
`phimdl_turing_universal` (Φ_MDL Turing universality; CatAL conditional; one named
axiom: `cook_rule110_simulates_computable`, via the Cook route composed with the
proved stepwise Φ_MDL–Rule 110 simulation).
