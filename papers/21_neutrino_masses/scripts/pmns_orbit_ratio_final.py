...
PDG = {"th12": 33.48, "th23": 42.10, "th13": 8.58, "dCP": 197.0}
SIG = {"th12": 0.78,  "th23": 0.77,  "th13": 0.13}
b_R = [5, 11, 19]
...
print(f"  PDG J ~ {math.sin(math.radians(33.48))*math.sin(math.radians(42.10))*math.sin(math.radians(8.58))*math.sin(math.radians(197.))*math.cos(math.radians(33.48))*math.cos(math.radians(42.10))*math.cos(math.radians(8.58)):.4e}")
...
print("""
  ...
  θ₁₂ (solar): sin²(θ₁₂) = strand²/c_H = 4/13
     ...
     Predicted: 33.69°  PDG: 33.48° ± 0.78°  Pull: +0.27σ ✓
  ...
  θ₂₃ (atmospheric): sin²(θ₂₃) = b_R(3)/b_L(2) = 19/42
     ...
     Predicted: 42.27°  PDG: 42.10° ± 0.77°  Pull: +0.22σ ✓
  ...
  θ₁₃ (reactor): sin(θ₁₃) = b_R(2)/b_L(1) = 11/73
     ...
     Predicted: 8.67°   PDG: 8.58° ± 0.13°   Pull: +0.67σ ✓

  δ_CP: 205.71° from Z₇ winding [CatAL, independent of texture — Round 5]

  Combined: χ² = 0.564 (3 zero-free-parameter predictions, all within 1σ)
""")
