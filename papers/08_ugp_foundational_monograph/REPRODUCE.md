...
`papers/08_ugp_foundational_monograph/main_n10_ridge.py` is a manuscript-adjacent utility; exact CLI flags may vary. Prefer `papers/08_ugp_foundational_monograph/ugp_release/ugp_cli.py` when a unified entry point is available in your checkout.
