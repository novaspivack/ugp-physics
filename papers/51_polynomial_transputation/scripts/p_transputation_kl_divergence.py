...
with open("/Users/nova/ugp-physics/research-sandbox/p_transputation_kl_results.json", "w") as f:
    json.dump(results, f, indent=2)

print(f"\n\nResults saved to research-sandbox/p_transputation_kl_results.json")
